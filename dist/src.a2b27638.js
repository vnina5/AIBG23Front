...
},{"./util.inspect":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/_empty.js"}],"node_modules/side-channel/index.js":[function(require,module,exports) {
'use strict';
...
},{"./stringify":"node_modules/qs/lib/stringify.js","./parse":"node_modules/qs/lib/parse.js","./formats":"node_modules/qs/lib/formats.js"}],"src/socket/ws.js":[function(require,module,exports) {
"use strict";
...
var WebsocketHandler = /*#__PURE__*/function () {
  ...
  _createClass(WebsocketHandler, [{
    ...
    value: function onMessage(message) {
      ...
      var playerAttack = JSON.parse(data.playerAttack);
      //nemamo time
...
},{}],"src/configuration.js":[function(require,module,exports) {
"use strict";
...
// export const API_ROOT = 'localhost:8081' // ovo je problem, radi kod kuce 
var API_ROOT = 'localhost:1234';

/*
export const API_ROOT = window.location.hostname === 'localhost' ? 'localhost:9080' : window.location.host;
export const API_ROOT = 'best1.aibg.best:9080'
ovde treba drugi server i port da gadjamo tj. endpoint <3
*/
...
if (gameId) {
  ...
  console.log(game);
  game.init();
  new _ws.WebsocketHandler("ws://".concat(_configuration.API_ROOT, "/streaming?gameId=").concat(gameId, "&password=salamala"), game); // 
  //console.log(game);
}
},{"qs":"node_modules/qs/lib/index.js","./socket/ws":"src/socket/ws.js","./configuration":"src/configuration.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
